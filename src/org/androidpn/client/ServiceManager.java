...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
       ...
       // props = loadProperties();
        ...
        apiKey = "0123456789";//props.getProperty("apiKey", "");
        xmppHost = QLCommon.xmppHost;//props.getProperty("xmppHost", "127.0.0.1");
        xmppPort = QLCommon.xmppPort;//props.getProperty("xmppPort", "5222");
        Log.i(LOGTAG, "apiKey=" + apiKey);
